...
public class TelaPrincipal extends javax.swing.JFrame {
    ...
    TimerTask envioApid = new TimerTask(){  
        @Override
        public void run() {
        
        PreparedStatement stn = null;
        
        String insertQuery = String.format("insert into registro (cpul, disco, memoria, dataHora, idRegistro)) values ('%s', %d, %d, getdate(), 1)",api.getProcessador().getUso().toString().replaceAll(",", "."), api.getGrupoDeDiscos().getTamanhoTotal(), api.getMemoria().getEmUso());
